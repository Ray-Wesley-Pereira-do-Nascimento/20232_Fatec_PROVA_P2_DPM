...
class _CatPhotoScreenState extends State<CatPhotoScreen> {
  ...
  Future<void> fetchCatPhotos() async {
    final response = await http.get(
      ...
      headers: {
        'x-api-key':
            'live_Jd4lS8bEDrGwfXXI9YvDEJFDWijbxobM9lUQ21kWl372E9C0mggVMPgvscTRaYcg',
      },
    );
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Erro! Falha ao carregar as fotos dos gatinhos.');
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Galeria de Gatinhos'),
      ),
      body: Container(
